...
function locate_statements_page() {
    ...
    while ($the_query->have_posts()) {
        ...
        while(have_rows('politic_statement')) {
            ...
            if ($statement_unmodified && !$autogenerated && !$same_as_autogenerated) {
                echo "<span style='color:blue;padding-left:15px;'>Istnieje wypowiedź nieredagowana (nie oznaczona jako autogenerowana oraz o treści inne niż byłaby autogenerowana), pomijam</span><br/>";
                continue;
            }
